...
桌面宿主进程具备 Per-Monitor-V2 DPI 感知；owoow 主控件和工具窗控件统一使用固定的 `7×15` 字体缩放基线；嵌入式 EasyCon 继承宿主 DPI，并使用 `Microsoft YaHei UI 9pt`。布局回归覆盖 100% 缩放下的逻辑几何，以及当前 150% 缩放下的视觉验证。
