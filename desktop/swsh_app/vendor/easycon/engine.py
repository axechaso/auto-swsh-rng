...
from swsh_app.vendor.easycon.ast import (
    ArrayLiteral,
    Binary,
    ButtonAction,
    Call,
...
from swsh_app.vendor.easycon.errors import ScriptCompileError, SourceLocation
from swsh_app.vendor.easycon.parser import parse_text
...
from swsh_app.vendor.easycon.validation import validate_program
from swsh_app.vendor.easycon.trace import ExecutionPoint
from swsh_app.vendor.easycon.pause import PauseControl
...
def _program_metadata(program: Program) -> tuple[frozenset[str], bool]:
    from swsh_app.vendor.easycon.ast import CallStatement
